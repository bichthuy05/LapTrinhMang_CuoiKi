...
_EXPECTED_BY_REQUEST = {
    ...
    # GROUP_ADD now creates an invitation
    "GROUP_ADD": {"GROUP_INVITE_SENT", "ERROR"},
    # New group-invite API
    "GROUP_INVITE_LIST": {"GROUP_INVITE_LIST_RESULT", "ERROR"},
    "GROUP_INVITE_ACCEPT": {"GROUP_INVITE_ACCEPTED", "ERROR"},
    "GROUP_INVITE_DECLINE": {"GROUP_INVITE_DECLINED", "ERROR"},
    # Backward-compat mapping for older web UI (will still receive ERROR from server if type unknown)
    "GROUP_ACCEPT_INVITATION": {"GROUP_INVITE_ACCEPTED", "ERROR"},
    "GROUP_REJECT_INVITATION": {"GROUP_INVITE_DECLINED", "ERROR"},
